...
p1 = figure(x_range=[-5, 5], y_range=[-5, 5], tools="pan,reset,resize,save,box_zoom,wheel_zoom",toolbar_location='above')
...
p2 = figure(x_range=[-5, 5], y_range=[-5, 5], tools="pan,reset,resize,save,box_zoom,wheel_zoom",toolbar_location='above')
p2.y_range = p1.y_range 
p2.x_range = p1.x_range 
p2.background_fill_color = "white"
p2.image_url(url=["http://www.stsci.edu/~tumlinso/JWST_source_z2.jpg"], x=[0], y=[0], w=10, h=10)

p3 = figure(x_range=[-5, 5], y_range=[-5, 5], tools="pan,reset,resize,save,box_zoom,wheel_zoom",toolbar_location='above')
p3.y_range = p1.y_range 
p3.x_range = p1.x_range 
p3.background_fill_color = "white"
p3.image_url(url=["http://www.stsci.edu/~tumlinso/HST_source_z2.jpg"], x=[0], y=[0], w=10, h=10)
